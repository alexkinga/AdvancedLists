...
@NgModule({
  imports: [RouterModule.forRoot([{ path: 'products', component: FilteredProductListComponent }, { path: 'products-sort', component: SortedProductListComponent }, { path: 'employee-filter', component: FilteredEmployeeListComponent }]), FilteredProductListComponentModule, CategoriesServiceModule, ProductsServiceModule, SortedProductListComponentModule, FilteredEmployeeListComponentModule, EmployeeServiceModule],
